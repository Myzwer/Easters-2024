<?php
/**
 * FAQ Template Partial (Light)
 *
 * This file generates an FAQ section for the site.
 *
 *
 * Usage: get_template_part( 'components/blocks/_faq-light');
 *
 * @package WordPress
...
<div class="bg-dark relative overflow-hidden">
    ...
    <div class="hidden xl:block absolute -right-32 -top-32">
        <img class="opacity-10 origin-top-left rotate-12" src="<?php the_field('thorns', 'options'); ?>" alt="Crown">
    </div>

    <div class="hidden xl:block absolute -left-32 -top-32">
        <img class="opacity-10" src="<?php the_field('crown', 'options'); ?>" alt="Palm Leaves">
    </div>
